...
function.This function can be used to clean up data retrieved from a database or from an HTML form.*/
 ...
 $userid= "SELECT * FROM admin WHERE username='$user'";

$user_password= $_POST["password"];
$user_password= "SELECT * FROM admin WHERE password='$password' "; 
...
<head>
	...
	<title>GadgetBytzz Admin Portal | Admin login</title>
...
<body>
			...
			<div class="container">
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						...
						<li><a href="http://localhost/Ecommerce_SQLI/">
						Back to Portal
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2022 GadgetBytzz Portal </b> All rights reserved.
		</div>
	</div>
