...
<h3>GadgetBytzz</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> One stop for all your gadget needs, Dreams about the future are always filled with gadgets.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>912-289-9467<br>951-522-9813</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">gadgetbytzz@yahoo.com</a></span>
                </div>
            </li>
