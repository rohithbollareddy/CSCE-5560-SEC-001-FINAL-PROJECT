...
{
	// if(validate($_POST['token']))
    // {
    //     echo "<script>alert('CSRF token is Validated');</script>";
    // }else 
    // {
    //     exit ("<script>alert('CSRF token not validated');</script>");
    // }
	$email=$_POST['email'];
   $password=md5($_POST['password']);
...
// $token = md5(time()); //hjdjh654165hgshgfhgv
// $_SESSION['token'] = $token;

// function validate($token)
//     {
//         return isset($_SESSION['token']) && isset($_SESSION['token']) 
// 		&& $_SESSION['token'] == $token;
//     }
